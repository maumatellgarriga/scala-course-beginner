...
object PatternMatching extends App {
  ...
  val greeting = bob match {
    case Person(n, a) if a < 21 => s"My name is $n and I can't drink in the US"
  ...
  /*
    ...
    2. what if no cases match? MatchError --> all cases has to be covered
  ...
  */
  ...
  animal match {
    case Dog(someBreed) => println(s"Matched dog of $someBreed breed")
  }

  // match everything .. WRONG
  val isEven = x match {
